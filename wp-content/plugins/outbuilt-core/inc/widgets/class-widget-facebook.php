...
if (!class_exists('Outbuilt_Addon_Facebook_Widget')) {
    class Outbuilt_Addon_Facebook_Widget extends WP_Widget {
        ...
        public function __construct() {
            parent::__construct(
                'outbuilt_facebook',
                esc_html__('&rarr; Facebook Like', 'outbuilt-core'),
                array(
                    'classname'   => 'widget_facebook_likebox',
                    'description' => esc_html__('Display a Facebook Like Box to connect visitors to your Facebook Page.', 'outbuilt-core'),
        ...
        public function widget($args, $instance) {
            ...
            if (empty($like_args['href']) || !$this->is_valid_facebook_url($like_args['href'])) {
                if (current_user_can('edit_theme_options')) {
                    echo $before_widget;
                    echo '<p>' . sprintf(esc_html__('It looks like your Facebook URL is incorrectly configured. Please check it in your <a href="%s">widget settings</a>.', 'outbuilt-core'), esc_url(admin_url('widgets.php'))) . '</p>';
                    echo $after_widget;
                }
            ...
            $like_bg_colour          = apply_filters('outbuilt_fb_likebox_bg', ('dark' == $like_args['colorscheme'] ? '#000' : '#fff'), $like_args['colorscheme']);
            ...
            if (!empty($title)) :
                ...
                echo apply_filters('outbuilt_facebook_likebox_title', $likebox_widget_title, $title, $page_url);
            ...
            <iframe src="<?php echo esc_url($like_url); ?>" scrolling="no" frameborder="0" style="border: none; overflow: hidden;<?php echo 0 != $like_args['width'] ? ' width: ' . (int) $like_args['width'] . 'px; ' : ''; ?> height: <?php echo (int) $like_args['height']; ?>px; background: <?php echo esc_attr($like_bg_colour); ?>"></iframe><?php
                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                    do_action('outbuilt_stats_extra', 'widget', 'facebook-likebox');
                                                                                                                                                                                                                                                                                                                                                }
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('href')); ?>"><?php esc_html_e('Facebook Page URL', 'outbuilt-core'); ?></label>
                ...
                <br />
                <small><?php esc_html_e('The Like Box only works with ', 'outbuilt-core'); ?><a href="http://www.facebook.com/help/?faq=174987089221178" target="_blank"><?php esc_html_e('Facebook Pages', 'outbuilt-core'); ?></a></small>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id('width')); ?>"><?php esc_html_e('Width', 'outbuilt-core'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('height')); ?>"><?php esc_html_e('Height', 'outbuilt-core'); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('colorscheme')); ?>"><?php esc_html_e('Color Scheme', 'outbuilt-core'); ?></label>
                <select name="<?php echo esc_attr($this->get_field_name('colorscheme')); ?>" id="<?php echo esc_attr($this->get_field_id('colorscheme')); ?>">
                    <option value="light" <?php selected($like_args['colorscheme'], 'light'); ?>><?php esc_html_e('Light', 'outbuilt-core'); ?></option>
                    <option value="dark" <?php selected($like_args['colorscheme'], 'dark'); ?>><?php esc_html_e('Dark', 'outbuilt-core'); ?></option>
                </select>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('show_faces')); ?>">
                    ...
                    <?php esc_html_e('Show Faces', 'outbuilt-core'); ?>
                    <br />
                    <small><?php esc_html_e('Show profile photos in the plugin.', 'outbuilt-core'); ?></small>
                </label>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('stream')); ?>">
                    ...
                    <?php esc_html_e('Show Stream', 'outbuilt-core'); ?>
                    <br />
                    <small><?php esc_html_e('Show the profile stream for the public profile.', 'outbuilt-core'); ?></small>
                </label>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('show_border')); ?>">
                    ...
                    <?php esc_html_e('Show Border', 'outbuilt-core'); ?>
                    <br />
                    <small><?php esc_html_e('Show a border around the plugin.', 'outbuilt-core'); ?></small>
                </label>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('force_wall')); ?>">
                    ...
                    <?php esc_html_e('Show Wall', 'outbuilt-core'); ?>
                    <br />
                    <small><?php esc_html_e('Show the wall for a Places page rather than friend activity.', 'outbuilt-core'); ?></small>
                </label>
            </p>
...
<?php
                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                public function get_default_args() {
                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                    return apply_filters('outbuilt_facebook_likebox_defaults', $defaults);
                                                                                                                                                                                                                                                                                                                                                }
                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                        register_widget('Outbuilt_Addon_Facebook_Widget');
