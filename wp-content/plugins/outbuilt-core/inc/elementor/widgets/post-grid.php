...
class Outbuilt_Core_Widget_Post_Grid extends Widget_Base {

	public function get_name() {
		return 'outbuilt-core-post-grid';
	}

	public function get_title() {
		return esc_html__( 'Post Grid', 'outbuilt-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_post',
			[
				'label' => esc_html__( 'Post Grid', 'outbuilt-core' ),
			]
		);
...
Plugin::instance()->widgets_manager->register_widget_type( new Outbuilt_Core_Widget_Post_Grid() );
